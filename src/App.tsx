            ...
            <div className="grid grid-cols-5 gap-3">
              {[
                ...
                <div key={label as string} className="bg-gray-50 rounded-xl p-3 text-center">
                  <p className="text-2xl font-black" style={{ color: getTeamColor(driver.teamId) }}>{val as number}</p>
                  <p className="text-[10px] uppercase tracking-wide text-gray-500 mt-1">{label as string}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-3">
              {[
                ...
                <div key={label as string} className="border border-gray-200 rounded-xl p-3 text-center">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={l as string} className="bg-gray-50 rounded-xl p-4 text-center">
                <p className="text-3xl font-black" style={{ color: team.color }}>{v as number}</p>
                <p className="text-[10px] uppercase tracking-wide text-gray-500 mt-1">{l as string}</p>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={l as string} className="bg-gray-50 rounded-xl p-3 text-center">
                <p className="text-lg font-black">{v as string | number}</p>
                <p className="text-[10px] uppercase tracking-wide text-gray-500">{l as string}</p>
              </div>
            ))}
          </div>
            ...
            <>
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={l as string} className="border border-gray-200 rounded-xl p-3 text-center">
                    <p className="text-sm font-black">{v as string}</p>
    ...
    <div className="min-h-screen bg-[#faf9f6] text-gray-900">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-xs">
                ...
                <span className="text-gray-400 uppercase tracking-widest">{nextRace.country}</span>
              </div>
              ...
              <div className="flex items-center gap-8 text-xs text-gray-400 pt-2 border-t border-gray-800 mt-4">
                <div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="relative">
          ...
          <div ref={calRef} className="flex gap-3 overflow-x-auto scrollbar-hide pb-4 px-10 snap-x">
            {races.map((race) => (
              <button
                key={race.round}
              ...
              >
                <div className="flex items-center gap-1 mb-2">
                  {race.status === "completed" && <span className="text-[9px] bg-green-600 text-white px-1 rounded font-bold">DONE</span>}
                  {race.status === "next" && <span className="text-[9px] bg-red-600 text-white px-1 rounded font-bold animate-pulse">NEXT</span>}
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400 uppercase tracking-widest mb-4">F1 · After 3 rounds</p>
            <div className="space-y-1">
              {drivers.map((d) => (
                <button
                  key={d.id}
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { label: "Races Completed", value: "3 / 23", sub: "13% of season" },
      ...
      <footer className="bg-[#0d0d0d] text-gray-500 text-center py-10 text-xs space-y-3">
        <div className="flex items-center justify-center gap-2 text-lg">
          ...
          <span className="font-black text-white text-sm">
            Shreya's <span className="italic text-red-500">Pit Wall</span>
          </span>
        </div>
        ...
        <div className="flex items-center justify-center gap-4 mt-2 text-gray-600">
          ...
          <span>Australia ✓</span>
          <span className="text-red-500 font-bold">Miami →</span>
        </div>
      </footer>
